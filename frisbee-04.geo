...
//+
For i In {1:8}
    	ss[] = Extrude {{Sin(theta), Cos(theta), 0}, {0, 0, 0}, Pi/2} {Curve{i}; Layers{20}; Recombine;};
	//+
	ss1[] = Extrude {{Sin(theta), Cos(theta), 0}, {0, 0, 0}, Pi/2} {Curve{ss[0]}; Layers{20}; Recombine;};
	//+
	ss2[] = Extrude {{Sin(theta), Cos(theta), 0}, {0, 0, 0}, Pi/2} {Curve{ss1[0]}; Layers{20}; Recombine;};
	//+
	ss3[] = Extrude {{Sin(theta), Cos(theta), 0}, {0, 0, 0}, Pi/2} {Curve{ss2[0]}; Layers{20}; Recombine;};
	//+
